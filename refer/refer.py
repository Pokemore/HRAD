...
class REFER:
    ...
    def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
        # provide data_root folder which contains refclef, refcoco, refcoco+, refcocog, RefSegRS, RRSIS-D, RISBench, RefDIOR, or RefOPT
        # also provide dataset name and splitBy information
        # e.g., dataset = 'refcoco', splitBy = 'unc'
        # e.g., dataset = 'RRSIS-D', splitBy = 'unc'
        # e.g., dataset = 'RefOPT', splitBy = 'unc'
        ...
        elif dataset.lower() in ['refsegrs', 'risbench', 'rrsis-d', 'refdior', 'refopt']:
